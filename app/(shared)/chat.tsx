/**
 * Chat screen — user ↔ admin conversation
 * Client / Provider see this screen via "Contact Support" button in their layouts.
 * Admin sees a separate chat-detail screen.
 */
...
export default function ChatScreen() {
  ...
  const getOrCreateChat = useCallback(async () => {
    ...
    setLoading(true);
    try {
      // Look for existing chat for this user
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          // Mark message as read if from admin
    ...
    return (
      <View style={{
        ...
        <View style={{
          ...
          <Text style={{
            color: isMe ? 'rgba(255,255,255,0.65)' : C.textMuted,
            fontSize: 11,
            fontFamily: 'Inter_400Regular',
            marginTop: 4,
            textAlign: 'right',
    ...
    <View style={{ flex: 1, backgroundColor: C.background }}>
      ...
      <View style={{
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={{ color: C.success, fontSize: 12, fontFamily: 'Inter_400Regular' }}>
            {es ? 'En línea' : 'Online'}
          </Text>
        </View>
      </View>
