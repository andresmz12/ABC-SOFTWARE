        ...
        <FlatList
          ...
          renderItem={({ item: n, index }) => (
            ...
            >
              ...
              {!n.read && (
                <View style={{ width: 7, height: 7, backgroundColor: C.accent, borderRadius: 4, marginTop: 4, marginLeft: 8 }} />
              )}
            </TouchableOpacity>
          )}
          ListEmptyComponent={
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 80 }}>
              <View style={{
                width: 72, height: 72, backgroundColor: C.surface2, borderRadius: 36,
                alignItems: 'center', justifyContent: 'center', marginBottom: 16, borderWidth: 1, borderColor: C.line,
              }}>
