  ...
  return (
    <ScreenWrapper scroll className="px-5">
      <View className="pt-8 pb-6">
        <Text className="text-text-muted font-body text-sm">{t('client.welcomeBack')}</Text>
      ...
      >
        <Text className="text-secondary font-body text-sm mb-1">{t('client.readyToClean')}</Text>
        ...
        <View className="bg-secondary rounded-xl py-3 px-5 mt-4 self-start">
          <Text className="text-white font-body-bold text-sm">{t('client.getStarted')}</Text>
        </View>
      </TouchableOpacity>
