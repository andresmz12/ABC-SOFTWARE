...
// ── Colombia: open job alerts ─────────────────────────────────────────────────
export const CO_DEMO_JOB_ALERTS: JobRequest[] = [
  {
    id: 'co-job-1',
    client_id: 'co-client-1',
    ...
    estimated_hours: 5,
    budget_cop: 450000,
    budget_max_cop: 600000,
    description: 'Limpieza de oficina — piso 3, El Poblado. Se requiere personal con experiencia en pisos de mármol.',
    status: 'open',
    expires_at: new Date(now + mins(110)).toISOString(),
    created_at: new Date(now - mins(10)).toISOString(),
  },
  {
    id: 'co-job-2',
    client_id: 'co-client-2',
    ...
    estimated_hours: 4,
    budget_cop: 320000,
    budget_max_cop: 380000,
    description: 'Apartamento de 3 habitaciones, servicio quincenal de limpieza. Insumos incluidos.',
    status: 'open',
    expires_at: new Date(now + mins(95)).toISOString(),
    created_at: new Date(now - mins(35)).toISOString(),
  },
  {
    id: 'co-job-3',
    client_id: 'co-client-3',
    ...
    estimated_hours: 8,
    budget_cop: 900000,
    budget_max_cop: 1200000,
    description: 'Remodelación de oficina — retiro de escombros y limpieza profunda. Todos los pisos y ventanas.',
    status: 'open',
    expires_at: new Date(now + hrs(1) + mins(15)).toISOString(),
    created_at: new Date(now - hrs(1)).toISOString(),
  },
];
